...
#define DEFAULT_THREAD_PRIORITY (seL4_MaxPrio - 5)
...
#define TMSERVERMOD_THREAD_PRIORITY (seL4_MaxPrio - 1)
#define TMSERVERMOD_STACK_SIZE DEFAULT_STACK_SIZE
#define TMSERVERMOD_BASE_BADGE (0x20)
...
#define CONSOLEMOD_BASE_BADGE (0x24)
